...
.. list-table::
   ...
   * - ``file``
     - File
     - No\*
     - Spectrum file to upload (FITS, DAT, TXT, or LNW)
   * - ``params``
     - String (JSON)
     - No
     - Processing parameters as JSON string
...
.. list-table::
   ...
   * - ``oscRef``
     - String
     - \-
     - SN name on Open Supernova Catalog (e.g., "sn2002er")
     -
   * - ``smoothing``
     - Integer
     - 0
   ...
   * - ``knownZ``
     - Boolean
     - false
     - Whether redshift is known
     -
   * - ``zValue``
     - Float
     - \-
     - Redshift value (required if knownZ=true)
     -
   * - ``minWave``
     - Float
     - \-
   ...
   * - ``calculateRlap``
     - Boolean
     - false
     - Whether to calculate RLAP values
     -
